...
<!--<div id="banderas" class="col-xs-12 col-sm-5 col-lg-4 pull-right">



    <img width="32px" height="27px" src="https://upload.wikimedia.org/wikipedia/commons/f/fc/Flag_of_Mexico.svg" alt="">

    <img width="32px" height="27px" src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/1a/Flag_of_Argentina.svg/125px-Flag_of_Argentina.svg.png" alt="">

    <img width="32px" height="27px" src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/cf/Flag_of_Peru.svg/125px-Flag_of_Peru.svg.png" alt="">

<img width="32px" height="27px" src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/78/Flag_of_Chile.svg/125px-Flag_of_Chile.svg.png" alt="">

    <img width="32px" height="27px" src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/21/Flag_of_Colombia.svg/125px-Flag_of_Colombia.svg.png" alt="">

    

    <img width="32px" height="27px" src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ab/Flag_of_Panama.svg/450px-Flag_of_Panama.svg.png" alt="">
...
<!--Banderas -->
           ...
           <nav id="nav-main" class="clearfix">
              ...
              <?php wp_nav_menu(array('theme_location' => 'deposits_header_menu', 'menu_class' => 'sf-menu')); ?>
